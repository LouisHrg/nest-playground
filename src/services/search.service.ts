...
export class SearchService implements SearchServiceInterface {
  ...
  async updateData(target, data, SerializerCallback = null): Promise<void> {
    let output = data;
    ...
    const index = this.client.index(target);
    const res = await index.updateDocuments(output);
  }

   async deleteData(target, data, SerializerCallback = null): Promise<void> {
    // let output = data;
    ...
    // const index = this.client.index(target);
    // const res = await index.deleteDocument(output);
  }
